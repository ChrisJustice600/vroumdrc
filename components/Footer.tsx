        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-bold">AutoDirect</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              Buy and sell your cars, with ease. AutoDirect connects car buyers and sellers directly, 
              providing a transparent and secure platform for automotive transactions.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">support@autodirect.com</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">123 Auto Street, Car City, AC 12345</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 AutoDirect. All rights reserved.
            </p>
