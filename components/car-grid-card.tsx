...
export function CarGridCard({
  ...
  return (
    <div
      className="bg-white rounded-sm shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col cursor-pointer"
    ...
    >
      ...
      <div className="p-3 sm:p-4 flex flex-col flex-grow">
        ...
        {/* Specifications Grid */}
        <div className="border-t border-gray-200 pt-3 sm:pt-4 mt-3 sm:mt-4 flex-grow">
