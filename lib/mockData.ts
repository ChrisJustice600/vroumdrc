...
export const mockCars: Car[] = [
  {
    ...
    description: 'Excellent condition BMW X5 with premium features, leather interior, and advanced safety systems.',
    brand: 'BMW',
    model: 'X5',
    year: 2022,
    mileage: 15000,
...
export const api = {
  ...
  // Subscription
  async activateSubscription(userId: string, paymentId: string): Promise<User | null> {
    return new Promise((resolve) => {
      setTimeout(() => {
...
export const carBrands = [
  ...
  'Volkswagen', 'Nissan', 'Hyundai', 'Mazda', 'Subaru', 'Lexus', 'Infiniti'
];